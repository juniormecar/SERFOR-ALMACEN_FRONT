...
export class PuestoControlService {
  ...
  getPuestoControlSearchBandeja(puestoControlRequest:PuestoControl, page: number, size: number): Observable<PuestoControlResponse> {
    let url = `${this.base}/listarBandejaPuestoControl?pageNumber=${page}&pageSize=${size}&sortType=DESC`; 
