...
export class AtfService {
  ...
  getATFSearchBandeja(atfRequest:ATF, page: number, size: number): Observable<AtfResponse> {
    let url = `${this.base}/listarBandejaATF?pageNumber=${page}&pageSize=${size}&sortType=DESC`;
