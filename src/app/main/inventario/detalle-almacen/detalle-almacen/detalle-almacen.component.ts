...
export class DetalleAlmacenComponent implements OnInit {
 ...
 listData: Recurso[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DetalleAlmacenComponent>,
...
saveStorage(cantidad: any, redondeo: any){
  ...
  getRecursos() {
    ...
    this._recursoService.getRecursoSearchVerProductos(null, null, null, null,this.data.idEspecie ,null,this.numeroDocumento,'A',this.data.nombreCientifico, this.data.nombreComun,null,null,this.data.nombreAlmacen,null,null,
  ...
  calculateTotales() {
    ...
    element.nuIdAlmacen = 0;    
    //element.nombreAlmacen = 'Totales';
