...
export class BandejaParametroComponent implements OnInit {
  ...
  search() {
    ...
    this.paramametroService.getParametroSearch(this.parametroRequest, this.parametroResponse.pageNumber, this.parametroResponse.pageSize).subscribe((response: ParametroResponse) => {
      if (response.success) {
