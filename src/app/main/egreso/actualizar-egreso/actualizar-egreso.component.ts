...
@Component({
  ...
  templateUrl: './actualizar-egreso.component.html',
  styleUrls: ['./actualizar-egreso.component.scss']
})
export class ActualizarEgresoComponent implements OnInit {
