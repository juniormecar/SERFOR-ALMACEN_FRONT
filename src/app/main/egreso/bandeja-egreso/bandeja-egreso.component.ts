...
// import { ModalDetalleDonacionComponent } from 'app/main/reporte/reportes-donaciones/reportes-donaciones.component';
...
@Component({
  selector: 'app-bandeja-egreso',
  templateUrl: './bandeja-egreso.component.html',
  styleUrls: ['./bandeja-egreso.component.scss']
})
export class BandejaEgresoComponent implements OnInit {
